!function(e,r,n){"use strict";r.module("FileManagerApp",["pascalprecht.translate"]),n(e.document).on("shown.bs.modal",".modal",function(){e.setTimeout(function(){n("[autofocus]",this).focus()}.bind(this),100)}),n(e.document).on("click",function(){n("#context-menu").hide()}),n(e.document).on("contextmenu",'.main-navigation .table-files tr.item-list:has("td"), .item-list',function(e){n("#context-menu").hide().css({left:e.pageX,top:e.pageY}).show(),e.preventDefault()}),Array.prototype.find||(Array.prototype.find=function(e){if(null==this)throw new TypeError("Array.prototype.find called on null or undefined");if("function"!=typeof e)throw new TypeError("predicate must be a function");for(var r,n=Object(this),i=n.length>>>0,t=arguments[1],a=0;i>a;a++)if(r=n[a],e.call(t,r,a,n))return r})}(window,angular,jQuery),function(e,r){"use strict";e.module("FileManagerApp").controller("FileManagerCtrl",["$scope","$rootScope","$window","$translate","fileManagerConfig","item","fileNavigator","apiMiddleware",function(n,i,t,a,o,s,l,d){var c=t.localStorage;n.config=e.merge({},o,n.config||{}),n.reverse=!1,n.predicate=["model.type","model.name"],n.order=function(e){n.reverse=n.predicate[1]===e?!n.reverse:!1,n.predicate[1]=e},n.query="",n.fileNavigator=new l(n.config),n.apiMiddleware=new d(n.config),n.uploadFileList=[],n.viewTemplate=c.getItem("viewTemplate")||"main-table.html",n.fileList=[],n.temps=[],n.$watch("temps",function(){if(n.singleSelection()?n.temp=n.singleSelection():(n.temp=new s({rights:644}),n.temp.multiple=!0),n.$parent.onSelectionChange){var e=[];if(n.temps)for(var r=0;r<n.temps.length;r++)e.push(n.temps[r].model);n.$parent.onSelectionChange(e)}n.temp.revert()},!0),n.fileNavigator.onRefresh=function(){n.temps=[],i.selectedModalPath=n.fileNavigator.currentPath},n.setTemplate=function(e){c.setItem("viewTemplate",e),n.viewTemplate=e},n.changeLanguage=function(e){return e?(c.setItem("language",e),a.use(e)):void a.use(c.getItem("language")||o.defaultLang)},n.isSelected=function(e){return-1!==n.temps.indexOf(e)},n.selectOrUnselect=function(e,r){var i=n.temps.indexOf(e),t=r&&3==r.which;if(r&&r.target.hasAttribute("prevent"))return void(n.temps=[]);if(!(!e||t&&n.isSelected(e))){if(!n.config.multiSelect)return void(n.temps=[e]);if(r&&r.shiftKey&&!t){var a=n.fileList,o=a.indexOf(e),s=n.temps[0],l=a.indexOf(s),d=void 0;if(s&&a.indexOf(s)<o){for(n.temps=[];o>=l;)d=a[l],!n.isSelected(d)&&n.temps.push(d),l++;return}if(s&&a.indexOf(s)>o){for(n.temps=[];l>=o;)d=a[l],!n.isSelected(d)&&n.temps.push(d),l--;return}}return r&&r.ctrlKey&&!t?void(n.isSelected(e)?n.temps.splice(i,1):n.temps.push(e)):void(n.temps=[e])}},n.singleSelection=function(){return 1===n.temps.length&&n.temps[0]},n.totalSelecteds=function(){return{total:n.temps.length}},n.selectionHas=function(e){return n.temps.find(function(r){return r&&r.model.type===e})},n.prepareNewFolder=function(){var e=new s(null,n.fileNavigator.currentPath);return n.temps=[e],e},n.smartClick=function(e){return e.isFolder()?n.fileNavigator.folderClick(e):e.isImage()?n.config.previewImagesInModal?n.openImagePreview(e):n.apiMiddleware.download(e,!0):e.isEditable()?n.openEditItem(e):void 0},n.openImagePreview=function(){var e=n.singleSelection();n.apiMiddleware.apiHandler.inprocess=!0,n.modal("imagepreview",null,!0).find("#imagepreview-target").attr("src",n.apiMiddleware.getUrl(e)).unbind("load error").on("load error",function(){n.apiMiddleware.apiHandler.inprocess=!1,n.$apply()})},n.openEditItem=function(){var e=n.singleSelection();n.apiMiddleware.getContent(e).then(function(r){e.tempModel.content=e.model.content=r.result}),n.modal("edit")},n.modal=function(e,i,t){var a=r("#"+e);return a.modal(i?"hide":"show"),n.apiMiddleware.apiHandler.error="",n.apiMiddleware.apiHandler.asyncSuccess=!1,t?a:!0},n.modalWithPathSelector=function(e){return i.selectedModalPath=n.fileNavigator.currentPath,n.modal(e)},n.isInThisPath=function(e){var r=n.fileNavigator.currentPath.join("/");return-1!==r.indexOf(e)},n.edit=function(){n.apiMiddleware.edit(n.singleSelection()).then(function(){n.modal("edit",!0)})},n.changePermissions=function(){n.apiMiddleware.changePermissions(n.temps,n.temp).then(function(){n.modal("changepermissions",!0)})},n.download=function(){var e=n.singleSelection();if(!n.selectionHas("dir"))return e?n.apiMiddleware.download(e):n.apiMiddleware.downloadMultiple(n.temps)},n.copy=function(){var e=n.singleSelection();if(e){var r=e.tempModel.name.trim(),t=n.fileNavigator.fileNameExists(r);if(t&&p(e))return n.apiMiddleware.apiHandler.error=a.instant("error_invalid_filename"),!1;if(!r)return n.apiMiddleware.apiHandler.error=a.instant("error_invalid_filename"),!1}n.apiMiddleware.copy(n.temps,i.selectedModalPath).then(function(){n.fileNavigator.refresh(),n.modal("copy",!0)})},n.compress=function(){var e=n.temp.tempModel.name.trim(),r=n.fileNavigator.fileNameExists(e);return r&&p(n.temp)?(n.apiMiddleware.apiHandler.error=a.instant("error_invalid_filename"),!1):e?void n.apiMiddleware.compress(n.temps,e,i.selectedModalPath).then(function(){return n.fileNavigator.refresh(),n.config.compressAsync?void(n.apiMiddleware.apiHandler.asyncSuccess=!0):n.modal("compress",!0)},function(){n.apiMiddleware.apiHandler.asyncSuccess=!1}):(n.apiMiddleware.apiHandler.error=a.instant("error_invalid_filename"),!1)},n.extract=function(){var e=n.temp,r=n.temp.tempModel.name.trim(),t=n.fileNavigator.fileNameExists(r);return t&&p(n.temp)?(n.apiMiddleware.apiHandler.error=a.instant("error_invalid_filename"),!1):r?void n.apiMiddleware.extract(e,r,i.selectedModalPath).then(function(){return n.fileNavigator.refresh(),n.config.extractAsync?void(n.apiMiddleware.apiHandler.asyncSuccess=!0):n.modal("extract",!0)},function(){n.apiMiddleware.apiHandler.asyncSuccess=!1}):(n.apiMiddleware.apiHandler.error=a.instant("error_invalid_filename"),!1)},n.remove=function(){n.apiMiddleware.remove(n.temps).then(function(){n.fileNavigator.refresh(),n.modal("remove",!0)})},n.move=function(){var e=n.singleSelection()||n.temps[0];return e&&p(e)?(n.apiMiddleware.apiHandler.error=a.instant("error_cannot_move_same_path"),!1):void n.apiMiddleware.move(n.temps,i.selectedModalPath).then(function(){n.fileNavigator.refresh(),n.modal("move",!0)})},n.rename=function(){var e=n.singleSelection(),r=e.tempModel.name,i=e.tempModel.path.join("")===e.model.path.join("");return!r||i&&n.fileNavigator.fileNameExists(r)?(n.apiMiddleware.apiHandler.error=a.instant("error_invalid_filename"),!1):void n.apiMiddleware.rename(e).then(function(){n.fileNavigator.refresh(),n.modal("rename",!0)})},n.createFolder=function(){var e=n.singleSelection(),r=e.tempModel.name;return!r||n.fileNavigator.fileNameExists(r)?n.apiMiddleware.apiHandler.error=a.instant("error_invalid_filename"):void n.apiMiddleware.createFolder(e).then(function(){n.fileNavigator.refresh(),n.modal("newfolder",!0)})},n.uploadFiles=function(){n.apiMiddleware.upload(n.uploadFileList,n.fileNavigator.currentPath).then(function(){n.fileNavigator.refresh(),n.modal("uploadfile",!0)},function(e){var r=e.result&&e.result.error||a.instant("error_uploading_files");n.apiMiddleware.apiHandler.error=r})};var p=function(e){var r=i.selectedModalPath.join(""),n=e&&e.model.path.join("");return n===r},m=function(e){var r=t.location.search.substr(1).split("&").filter(function(r){return e===r.split("=")[0]});return r[0]&&r[0].split("=")[1]||void 0};n.changeLanguage(m("lang")),n.isWindows="Windows"===m("server"),n.fileNavigator.refresh()}])}(angular,jQuery),function(e){"use strict";e.module("FileManagerApp").controller("ModalFileManagerCtrl",["$scope","$rootScope","fileNavigator",function(e,r,n){e.reverse=!1,e.predicate=["model.type","model.name"],e.fileNavigator=new n,r.selectedModalPath=[],e.order=function(r){e.reverse=e.predicate[1]===r?!e.reverse:!1,e.predicate[1]=r},e.select=function(n){r.selectedModalPath=n.model.fullPath().split("/"),e.modal("selector",!0)},e.selectCurrent=function(){r.selectedModalPath=e.fileNavigator.currentPath,e.modal("selector",!0)},e.selectedFilesAreChildOfPath=function(r){var n=r.model.fullPath();return e.temps.find(function(e){var r=e.model.fullPath();return n==r?!0:void 0})},r.openNavigator=function(r){e.fileNavigator.currentPath=r,e.fileNavigator.refresh(),e.modal("selector")},r.getSelectedPath=function(){var n=r.selectedModalPath.filter(Boolean),i="/"+n.join("/");return e.singleSelection()&&!e.singleSelection().isFolder()&&(i+="/"+e.singleSelection().tempModel.name),i.replace(/\/\//,"/")}}])}(angular),function(e){"use strict";var r=e.module("FileManagerApp");r.directive("angularFilemanager",["$parse","fileManagerConfig",function(e,r){return{restrict:"EA",templateUrl:r.tplPath+"/main.html",scope:{selectedItems:"=?",config:"=?"},link:function(e,r,n){e.onSelectionChange=function(r){e.selectedItems=r}}}}]),r.directive("ngFile",["$parse",function(e){return{restrict:"A",link:function(r,n,i){var t=e(i.ngFile),a=t.assign;n.bind("change",function(){r.$apply(function(){a(r,n[0].files)})})}}}]),r.directive("ngRightClick",["$parse",function(e){return function(r,n,i){var t=e(i.ngRightClick);n.bind("contextmenu",function(e){r.$apply(function(){e.preventDefault(),t(r,{$event:e})})})}}])}(angular),function(e){"use strict";e.module("FileManagerApp").service("chmod",function(){var e=function(e){if(this.owner=this.getRwxObj(),this.group=this.getRwxObj(),this.others=this.getRwxObj(),e){var r=isNaN(e)?this.convertfromCode(e):this.convertfromOctal(e);if(!r)throw new Error("Invalid chmod input data (%s)".replace("%s",e));this.owner=r.owner,this.group=r.group,this.others=r.others}};return e.prototype.toOctal=function(e,r){var n=[];return["owner","group","others"].forEach(function(e,r){n[r]=this[e].read&&this.octalValues.read||0,n[r]+=this[e].write&&this.octalValues.write||0,n[r]+=this[e].exec&&this.octalValues.exec||0}.bind(this)),(e||"")+n.join("")+(r||"")},e.prototype.toCode=function(e,r){var n=[];return["owner","group","others"].forEach(function(e,r){n[r]=this[e].read&&this.codeValues.read||"-",n[r]+=this[e].write&&this.codeValues.write||"-",n[r]+=this[e].exec&&this.codeValues.exec||"-"}.bind(this)),(e||"")+n.join("")+(r||"")},e.prototype.getRwxObj=function(){return{read:!1,write:!1,exec:!1}},e.prototype.octalValues={read:4,write:2,exec:1},e.prototype.codeValues={read:"r",write:"w",exec:"x"},e.prototype.convertfromCode=function(e){if(e=(""+e).replace(/\s/g,""),e=10===e.length?e.substr(1):e,/^[-rwxts]{9}$/.test(e)){var r=[],n=e.match(/.{1,3}/g);for(var i in n){var t=this.getRwxObj();t.read=/r/.test(n[i]),t.write=/w/.test(n[i]),t.exec=/x|t/.test(n[i]),r.push(t)}return{owner:r[0],group:r[1],others:r[2]}}},e.prototype.convertfromOctal=function(e){if(e=(""+e).replace(/\s/g,""),e=4===e.length?e.substr(1):e,/^[0-7]{3}$/.test(e)){var r=[],n=e.match(/.{1}/g);for(var i in n){var t=this.getRwxObj();t.read=/[4567]/.test(n[i]),t.write=/[2367]/.test(n[i]),t.exec=/[1357]/.test(n[i]),r.push(t)}return{owner:r[0],group:r[1],others:r[2]}}},e})}(angular),function(e){"use strict";e.module("FileManagerApp").factory("item",["fileManagerConfig","chmod",function(r,n){var i=function(r,i){function t(e){var r=(e||"").toString().split(/[- :]/);return new Date(r[0],r[1]-1,r[2],r[3],r[4],r[5])}var a={name:r&&r.name||"",path:i||[],type:r&&r.type||"file",size:r&&parseInt(r.size||0),date:t(r&&r.date),perms:new n(r&&r.rights),content:r&&r.content||"",recursive:!1,fullPath:function(){var e=this.path.filter(Boolean);return("/"+e.join("/")+"/"+this.name).replace(/\/\//,"/")}};this.error="",this.processing=!1,this.model=e.copy(a),this.tempModel=e.copy(a)};return i.prototype.update=function(){e.extend(this.model,e.copy(this.tempModel))},i.prototype.revert=function(){e.extend(this.tempModel,e.copy(this.model)),this.error=""},i.prototype.isFolder=function(){return"dir"===this.model.type},i.prototype.isEditable=function(){return!this.isFolder()&&r.isEditableFilePattern.test(this.model.name)},i.prototype.isImage=function(){return r.isImageFilePattern.test(this.model.name)},i.prototype.isCompressible=function(){return this.isFolder()},i.prototype.isExtractable=function(){return!this.isFolder()&&r.isExtractableFilePattern.test(this.model.name)},i}])}(angular),function(e){"use strict";var r=e.module("FileManagerApp");r.filter("strLimit",["$filter",function(e){return function(r,n){return r.length<=n?r:e("limitTo")(r,n)+"..."}}]),r.filter("formatDate",["$filter",function(){return function(e){return e instanceof Date?e.toISOString().substring(0,19).replace("T"," "):(e.toLocaleString||e.toString).apply(e)}}]),r.filter("humanReadableFileSize",["$filter","fileManagerConfig",function(e,r){var n=[" kB"," MB"," GB"," TB","PB","EB","ZB","YB"],i=["KiB","MiB","GiB","TiB","PiB","EiB","ZiB","YiB"];return function(e){var t=-1,a=e;do a/=1024,t++;while(a>1024);var o=r.useBinarySizePrefixes?i[t]:n[t];return Math.max(a,.1).toFixed(1)+" "+o}}])}(angular),function(e,r){"use strict";e.module("FileManagerApp").service("apiHandler",["$http","$q","$window","$translate",function(n,i,t,a){n.defaults.headers.common["X-Requested-With"]="XMLHttpRequest";var o=function(){this.inprocess=!1,this.asyncSuccess=!1,this.error=""};return o.prototype.deferredHandler=function(e,r,n){return e&&"object"==typeof e||(this.error="Bridge response error, please check the docs"),e.result&&e.result.error&&(this.error=e.result.error),!this.error&&e.error&&(this.error=e.error.message),!this.error&&n&&(this.error=n),this.error?r.reject(e):r.resolve(e)},o.prototype.list=function(e,r,t){var a=this,o=t||a.deferredHandler,s=i.defer(),l={action:"list",path:r};return a.inprocess=!0,a.error="",n.post(e,l).success(function(e){o(e,s)}).error(function(e){o(e,s,"Unknown error listing, check the response")})["finally"](function(){a.inprocess=!1}),s.promise},o.prototype.copy=function(e,r,t){var o=this,s=i.defer(),l={action:"copy",items:r,newPath:t};return o.inprocess=!0,o.error="",n.post(e,l).success(function(e){o.deferredHandler(e,s)}).error(function(e){o.deferredHandler(e,s,a.instant("error_copying"))})["finally"](function(){o.inprocess=!1}),s.promise},o.prototype.move=function(e,r,t){var o=this,s=i.defer(),l={action:"move",items:r,newPath:t};return o.inprocess=!0,o.error="",n.post(e,l).success(function(e){o.deferredHandler(e,s)}).error(function(e){o.deferredHandler(e,s,a.instant("error_moving"))})["finally"](function(){o.inprocess=!1}),s.promise},o.prototype.remove=function(e,r){var t=this,o=i.defer(),s={action:"remove",items:r};return t.inprocess=!0,t.error="",n.post(e,s).success(function(e){t.deferredHandler(e,o)}).error(function(e){t.deferredHandler(e,o,a.instant("error_deleting"))})["finally"](function(){t.inprocess=!1}),o.promise},o.prototype.upload=function(r,t){var a=this,o=i.defer();return a.inprocess=!0,a.error="",n.post(r,t,{transformRequest:e.identity,headers:{"Content-Type":void 0}}).success(function(e){a.deferredHandler(e,o)}).error(function(e){a.deferredHandler(e,o,"Unknown error uploading files")})["finally"](function(){a.inprocess=!1}),o.promise},o.prototype.getContent=function(e,r){var t=this,o=i.defer(),s={action:"getContent",item:r};return t.inprocess=!0,t.error="",n.post(e,s).success(function(e){t.deferredHandler(e,o)}).error(function(e){t.deferredHandler(e,o,a.instant("error_getting_content"))})["finally"](function(){t.inprocess=!1}),o.promise},o.prototype.edit=function(e,r,t){var o=this,s=i.defer(),l={action:"edit",item:r,content:t};return o.inprocess=!0,o.error="",n.post(e,l).success(function(e){o.deferredHandler(e,s)}).error(function(e){o.deferredHandler(e,s,a.instant("error_modifying"))})["finally"](function(){o.inprocess=!1}),s.promise},o.prototype.rename=function(e,r,t){var o=this,s=i.defer(),l={action:"rename",item:r,newItemPath:t};return o.inprocess=!0,o.error="",n.post(e,l).success(function(e){o.deferredHandler(e,s)}).error(function(e){o.deferredHandler(e,s,a.instant("error_renaming"))})["finally"](function(){o.inprocess=!1}),s.promise},o.prototype.getUrl=function(e,n){var i={action:"download",path:n};return n&&[e,r.param(i)].join("?")},o.prototype.download=function(e,r,o,s,l){var d=this,c=this.getUrl(e,r);if(!s||l||!t.saveAs)return!t.saveAs&&t.console.error("Your browser dont support ajax download, downloading by default"),!!t.open(c,"_blank","");var p=i.defer();return d.inprocess=!0,n.get(c).success(function(e){var r=new t.Blob([e]);p.resolve(e),t.saveAs(r,o)}).error(function(e){d.deferredHandler(e,p,a.instant("error_downloading"))})["finally"](function(){d.inprocess=!1}),p.promise},o.prototype.downloadMultiple=function(e,o,s,l,d){var c=this,p=i.defer(),m={action:"downloadMultiple",items:o,toFilename:s},u=[e,r.param(m)].join("?");return l&&!d&&t.saveAs?(c.inprocess=!0,n.get(e).success(function(e){var r=new t.Blob([e]);p.resolve(e),t.saveAs(r,s)}).error(function(e){c.deferredHandler(e,p,a.instant("error_downloading"))})["finally"](function(){c.inprocess=!1}),p.promise):(!t.saveAs&&t.console.error("Your browser dont support ajax download, downloading by default"),!!t.open(u,"_blank",""))},o.prototype.compress=function(e,r,t,o){var s=this,l=i.defer(),d={action:"compress",items:r,destination:o,compressedFilename:t};return s.inprocess=!0,s.error="",n.post(e,d).success(function(e){s.deferredHandler(e,l)}).error(function(e){s.deferredHandler(e,l,a.instant("error_compressing"))})["finally"](function(){s.inprocess=!1}),l.promise},o.prototype.extract=function(e,r,t,o){var s=this,l=i.defer(),d={action:"extract",item:r,destination:o,folderName:t};return s.inprocess=!0,s.error="",n.post(e,d).success(function(e){s.deferredHandler(e,l)}).error(function(e){s.deferredHandler(e,l,a.instant("error_extracting"))})["finally"](function(){s.inprocess=!1}),l.promise},o.prototype.changePermissions=function(e,r,t,o,s){var l=this,d=i.defer(),c={action:"changePermissions",items:r,perms:t,permsCode:o,recursive:!!s};return l.inprocess=!0,l.error="",n.post(e,c).success(function(e){l.deferredHandler(e,d)}).error(function(e){l.deferredHandler(e,d,a.instant("error_changing_perms"))})["finally"](function(){l.inprocess=!1}),d.promise},o.prototype.createFolder=function(e,r){var t=this,o=i.defer(),s={action:"createFolder",newPath:r};return t.inprocess=!0,t.error="",n.post(e,s).success(function(e){t.deferredHandler(e,o)}).error(function(e){t.deferredHandler(e,o,a.instant("error_creating_folder"))})["finally"](function(){t.inprocess=!1}),o.promise},o}])}(angular,jQuery),function(e){"use strict";e.module("FileManagerApp").service("apiMiddleware",["$window","fileManagerConfig","apiHandler",function(e,r,n){var i=function(e){this.config=e||r,this.apiHandler=new n};return i.prototype.getPath=function(e){return"/"+e.join("/")},i.prototype.getFileList=function(e){return(e||[]).map(function(e){return e&&e.model.fullPath()})},i.prototype.getFilePath=function(e){return e&&e.model.fullPath()},i.prototype.list=function(e,r){return this.apiHandler.list(this.config.listUrl,this.getPath(e),r)},i.prototype.copy=function(e,r){var n=this.getFileList(e);return this.apiHandler.copy(this.config.copyUrl,n,this.getPath(r))},i.prototype.move=function(e,r){var n=this.getFileList(e);return this.apiHandler.move(this.config.moveUrl,n,this.getPath(r))},i.prototype.remove=function(e){var r=this.getFileList(e);return this.apiHandler.remove(this.config.removeUrl,r)},i.prototype.upload=function(r,n){if(!e.FormData)throw new Error("Unsupported browser version");var i=new e.FormData;i.append("destination",this.getPath(n));for(var t=0;t<r.length;t++){var a=r.item(t);a instanceof e.File&&i.append("file-"+t,a)}return this.apiHandler.upload(this.config.uploadUrl,i)},i.prototype.getContent=function(e){var r=this.getFilePath(e);return this.apiHandler.getContent(this.config.getContentUrl,r)},i.prototype.edit=function(e){var r=this.getFilePath(e);return this.apiHandler.edit(this.config.editUrl,r,e.tempModel.content)},i.prototype.rename=function(e){var r=this.getFilePath(e),n=e.tempModel.fullPath();return this.apiHandler.rename(this.config.renameUrl,r,n)},i.prototype.getUrl=function(e){var r=this.getFilePath(e);return this.apiHandler.getUrl(this.config.downloadFileUrl,r)},i.prototype.download=function(e,r){var n=this.getFilePath(e),i=e.model.name;return e.isFolder()?void 0:this.apiHandler.download(this.config.downloadFileUrl,n,i,this.config.downloadFilesByAjax,r)},i.prototype.downloadMultiple=function(e,r){var n=this.getFileList(e),i=(new Date).getTime().toString().substr(8,13),t=i+"-"+this.config.multipleDownloadFileName;return this.apiHandler.downloadMultiple(this.config.downloadMultipleUrl,n,t,this.config.downloadFilesByAjax,r)},i.prototype.compress=function(e,r,n){var i=this.getFileList(e);return this.apiHandler.compress(this.config.compressUrl,i,r,this.getPath(n))},i.prototype.extract=function(e,r,n){var i=this.getFilePath(e);return this.apiHandler.extract(this.config.extractUrl,i,r,this.getPath(n))},i.prototype.changePermissions=function(e,r){var n=this.getFileList(e),i=r.tempModel.perms.toCode(),t=r.tempModel.perms.toOctal(),a=!!r.tempModel.recursive;return this.apiHandler.changePermissions(this.config.permissionsUrl,n,i,t,a)},i.prototype.createFolder=function(e){var r=e.tempModel.fullPath();return this.apiHandler.createFolder(this.config.createFolderUrl,r)},i}])}(angular),function(e){"use strict";e.module("FileManagerApp").service("fileNavigator",["apiMiddleware","fileManagerConfig","item",function(e,r,n){var i=function(n){this.config=n||r,this.apiMiddleware=new e(this.config),this.requesting=!1,this.fileList=[],this.currentPath=[],this.history=[],this.error="",this.onRefresh=function(){}};return i.prototype.deferredHandler=function(e,r,n){return e&&"object"==typeof e||(this.error="Bridge response error, please check the docs"),!this.error&&e.result&&e.result.error&&(this.error=e.result.error),!this.error&&e.error&&(this.error=e.error.message),!this.error&&n&&(this.error=n),this.error?r.reject(e):r.resolve(e)},i.prototype.list=function(){return this.apiMiddleware.list(this.currentPath,this.deferredHandler.bind(this))},i.prototype.refresh=function(){var e=this,r=e.currentPath.join("/");return e.requesting=!0,e.fileList=[],e.list().then(function(i){e.fileList=(i.result||[]).map(function(r){return new n(r,e.currentPath)}),e.buildTree(r),e.onRefresh()})["finally"](function(){e.requesting=!1})},i.prototype.buildTree=function(e){function r(e,n,i){var t=i?i+"/"+n.model.name:n.model.name;if(e.name.trim()&&0!==i.trim().indexOf(e.name)&&(e.nodes=[]),e.name!==i)e.nodes.forEach(function(e){r(e,n,i)});else{for(var a in e.nodes)if(e.nodes[a].name===t)return;e.nodes.push({item:n,name:t,nodes:[]})}e.nodes=e.nodes.sort(function(e,r){return e.name.toLowerCase()<r.name.toLowerCase()?-1:e.name.toLowerCase()===r.name.toLowerCase()?0:1})}function i(e,r){r.push(e);for(var n in e.nodes)i(e.nodes[n],r)}function t(e,r){return e.filter(function(e){return e.name===r})[0]}var a=[],o={};!this.history.length&&this.history.push({name:"",nodes:[]}),i(this.history[0],a),o=t(a,e),o&&(o.nodes=[]);for(var s in this.fileList){var l=this.fileList[s];l instanceof n&&l.isFolder()&&r(this.history[0],l,e)}},i.prototype.folderClick=function(e){this.currentPath=[],e&&e.isFolder()&&(this.currentPath=e.model.fullPath().split("/").splice(1)),this.refresh()},i.prototype.upDir=function(){this.currentPath[0]&&(this.currentPath=this.currentPath.slice(0,-1),this.refresh())},i.prototype.goTo=function(e){this.currentPath=this.currentPath.slice(0,e+1),this.refresh()},i.prototype.fileNameExists=function(e){return this.fileList.find(function(r){return e.trim&&r.model.name.trim()===e.trim()})},i.prototype.listHasFolders=function(){return this.fileList.find(function(e){return"dir"===e.model.type})},i}])}(angular),function(e){"use strict";e.module("FileManagerApp").provider("fileManagerConfig",function(){var r={appName:"angular-filemanager v1.5",defaultLang:"en",listUrl:"bridges/php/handler.php",uploadUrl:"bridges/php/handler.php",renameUrl:"bridges/php/handler.php",copyUrl:"bridges/php/handler.php",moveUrl:"bridges/php/handler.php",removeUrl:"bridges/php/handler.php",editUrl:"bridges/php/handler.php",getContentUrl:"bridges/php/handler.php",createFolderUrl:"bridges/php/handler.php",downloadFileUrl:"bridges/php/handler.php",downloadMultipleUrl:"bridges/php/handler.php",compressUrl:"bridges/php/handler.php",extractUrl:"bridges/php/handler.php",permissionsUrl:"bridges/php/handler.php",searchForm:!0,sidebar:!0,breadcrumb:!0,allowedActions:{upload:!0,rename:!0,move:!0,copy:!0,edit:!0,changePermissions:!0,compress:!0,compressChooseName:!0,extract:!0,download:!0,downloadMultiple:!0,preview:!0,remove:!0},multiSelect:!0,multipleDownloadFileName:"angular-filemanager.zip",showSizeForDirectories:!1,useBinarySizePrefixes:!1,downloadFilesByAjax:!0,previewImagesInModal:!0,enablePermissionsRecursive:!0,compressAsync:!1,extractAsync:!1,isEditableFilePattern:/\.(txt|diff?|patch|svg|asc|cnf|cfg|conf|html?|.html|cfm|cgi|aspx?|ini|pl|py|md|css|cs|js|jsp|log|htaccess|htpasswd|gitignore|gitattributes|env|json|atom|eml|rss|markdown|sql|xml|xslt?|sh|rb|as|bat|cmd|cob|for|ftn|frm|frx|inc|lisp|scm|coffee|php[3-6]?|java|c|cbl|go|h|scala|vb|tmpl|lock|go|yml|yaml|tsv|lst)$/i,isImageFilePattern:/\.(jpe?g|gif|bmp|png|svg|tiff?)$/i,isExtractableFilePattern:/\.(gz|tar|rar|g?zip)$/i,tplPath:"src/templates"};return{$get:function(){return r},set:function(n){e.extend(r,n)}}})}(angular),function(e){"use strict";e.module("FileManagerApp").config(["$translateProvider",function(e){e.useSanitizeValueStrategy(null),e.translations("en",{filemanager:"File Manager",language:"Language",english:"English",spanish:"Spanish",portuguese:"Portuguese",french:"French",german:"German",hebrew:"Hebrew",slovak:"Slovak",chinese:"中文",confirm:"Confirm",cancel:"Cancel",close:"Close",upload_files:"Upload files",files_will_uploaded_to:"Files will be uploaded to",select_files:"Select files",uploading:"Uploading",permissions:"Permissions",select_destination_folder:"Select the destination folder",source:"Source",destination:"Destination",copy_file:"Copy file",sure_to_delete:"Are you sure to delete",change_name_move:"Change name / move",enter_new_name_for:"Enter new name for",extract_item:"Extract item",extraction_started:"Extraction started in a background process",compression_started:"Compression started in a background process",enter_folder_name_for_extraction:"Enter the folder name for the extraction of",enter_file_name_for_compression:"Enter the file name for the compression of",toggle_fullscreen:"Toggle fullscreen",edit_file:"Edit file",file_content:"File content",loading:"Loading",search:"Search",create_folder:"Create folder",create:"Create",folder_name:"Folder name",upload:"Upload",change_permissions:"Change permissions",change:"Change",details:"Details",icons:"Icons",list:"List",name:"Name",size:"Size",actions:"Actions",date:"Date",no_files_in_folder:"No files in this folder",no_folders_in_folder:"This folder not contains children folders",select_this:"Select this",go_back:"Go back",wait:"Wait",move:"Move",download:"Download",view_item:"View item",remove:"Delete",edit:"Edit",copy:"Copy",rename:"Rename",extract:"Extract",compress:"Compress",error_invalid_filename:"Invalid filename or already exists, specify another name",error_modifying:"An error occurred modifying the file",error_deleting:"An error occurred deleting the file or folder",error_renaming:"An error occurred renaming the file",error_copying:"An error occurred copying the file",error_compressing:"An error occurred compressing the file or folder",error_extracting:"An error occurred extracting the file",error_creating_folder:"An error occurred creating the folder",error_getting_content:"An error occurred getting the content of the file",error_changing_perms:"An error occurred changing the permissions of the file",error_uploading_files:"An error occurred uploading files",sure_to_start_compression_with:"Are you sure to compress",owner:"Owner",group:"Group",others:"Others",read:"Read",write:"Write",exec:"Exec",original:"Original",changes:"Changes",recursive:"Recursive",preview:"Item preview",open:"Open",these_elements:"these {{total}} elements",new_folder:"New folder"}),e.translations("he",{filemanager:"מנהל קבצים",language:"שפה",english:"אנגלית",spanish:"ספרדית",portuguese:"פורטוגזית",french:"צרפתית",german:"גרמנית",hebrew:"עברי",slovak:"סלובקי",chinese:"中文",confirm:"אשר",cancel:"בטל",close:"סגור",upload_files:"העלה קבצים",files_will_uploaded_to:"הקבצים יעלו ל",select_files:"בחר קבצים",uploading:"מעלה",permissions:"הרשאות",select_destination_folder:"בחר תיקיית יעד",source:"מקור",destination:"יעד",copy_file:"העתק קובץ",sure_to_delete:"האם אתה בטוח שברצונך למחוק",change_name_move:"שנה שם / הזז",enter_new_name_for:"הקלד שם חדש עבור",extract_item:"חלץ פריט",extraction_started:"תהליך החילוץ מתבצע ברקע",compression_started:"תהליך הכיווץ מתבצע ברקע",enter_folder_name_for_extraction:"הקלד שם תיקייה לחילוץ עבור",enter_file_name_for_compression:"הזן את שם הקובץ עבור הדחיסה של",toggle_fullscreen:"הפעל/בטל מסך מלא",edit_file:"ערוך קובץ",file_content:"תוכן הקובץ",loading:"טוען",search:"חפש",create_folder:"צור תיקייה",create:"צור",folder_name:"שם תיקייה",upload:"העלה",change_permissions:"שנה הרשאות",change:"שנה",details:"פרטים",icons:"סמלים",list:"רשימה",name:"שם",size:"גודל",actions:"פעולות",date:"תאריך",no_files_in_folder:"אין קבצים בתיקייה זו",no_folders_in_folder:"התיקייה הזו אינה כוללת תתי תיקיות",select_this:"בחר את זה",go_back:"חזור אחורה",wait:"חכה",move:"הזז",download:"הורד",view_item:"הצג פריט",remove:"מחק",edit:"ערוך",copy:"העתק",rename:"שנה שם",extract:"חלץ",compress:"כווץ",error_invalid_filename:"שם קובץ אינו תקין או קיים, ציין שם קובץ אחר",error_modifying:"התרחשה שגיאה בעת שינוי הקובץ",error_deleting:"התרחשה שגיאה בעת מחיקת הקובץ או התיקייה",error_renaming:"התרחשה שגיאה בעת שינוי שם הקובץ",error_copying:"התרחשה שגיאה בעת העתקת הקובץ",error_compressing:"התרחשה שגיאה בעת כיווץ הקובץ או התיקייה",error_extracting:"התרחשה שגיאה בעת חילוץ הקובץ או התיקייה",error_creating_folder:"התרחשה שגיאה בעת יצירת התיקייה",error_getting_content:"התרחשה שגיאה בעת בקשת תוכן הקובץ",error_changing_perms:"התרחשה שגיאה בעת שינוי הרשאות הקובץ",error_uploading_files:"התרחשה שגיאה בעת העלאת הקבצים",sure_to_start_compression_with:"האם אתה בטוח שברצונך לכווץ",owner:"בעלים",group:"קבוצה",others:"אחרים",read:"קריאה",write:"כתיבה",exec:"הרצה",original:"מקורי",changes:"שינויים",recursive:"רקורסיה",preview:"הצגת פריט",open:"פתח",new_folder:"תיקיה חדשה"}),e.translations("pt",{filemanager:"Gerenciador de arquivos",language:"Língua",english:"Inglês",spanish:"Espanhol",portuguese:"Portugues",french:"Francês",german:"Alemão",hebrew:"Hebraico",slovak:"Eslovaco",chinese:"中文",confirm:"Confirmar",cancel:"Cancelar",close:"Fechar",upload_files:"Carregar arquivos",files_will_uploaded_to:"Os arquivos serão enviados para",select_files:"Selecione os arquivos",uploading:"Carregar",permissions:"Autorizações",select_destination_folder:"Selecione a pasta de destino",source:"Origem",destination:"Destino",copy_file:"Copiar arquivo",sure_to_delete:"Tem certeza de que deseja apagar",change_name_move:"Renomear / mudança",enter_new_name_for:"Digite o novo nome para",extract_item:"Extrair arquivo",extraction_started:"A extração começou em um processo em segundo plano",compression_started:"A compressão começou em um processo em segundo plano",enter_folder_name_for_extraction:"Digite o nome da pasta para a extração de",enter_file_name_for_compression:"Digite o nome do arquivo para a compressão de",toggle_fullscreen:"Ativar/desativar tela cheia",edit_file:"Editar arquivo",file_content:"Conteúdo do arquivo",loading:"Carregando",search:"Localizar",create_folder:"Criar Pasta",create:"Criar",folder_name:"Nome da pasta",upload:"Fazer",change_permissions:"Alterar permissões",change:"Alterar",details:"Detalhes",icons:"Icones",list:"Lista",name:"Nome",size:"Tamanho",actions:"Ações",date:"Data",no_files_in_folder:"Não há arquivos nesta pasta",no_folders_in_folder:"Esta pasta não contém subpastas",select_this:"Selecione esta",go_back:"Voltar",wait:"Espere",move:"Mover",download:"Baixar",view_item:"Veja o arquivo",remove:"Excluir",edit:"Editar",copy:"Copiar",rename:"Renomear",extract:"Extrair",
